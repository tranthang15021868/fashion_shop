...
// });
Route::get('category/{id}/{tenloai}', ['as' => 'loaisanpham', 'uses' => 'HomeController@loaiSanPham']);
Route::get('product/{id}/{product_detail}', ['as' => 'product_detail', 'uses' => 'HomeController@product']);
// send Mail
